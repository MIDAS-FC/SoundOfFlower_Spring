...
public enum ErrorCode {
    ...
    NOT_EXIST_ADMIN_PLAYLIST(HttpStatus.NOT_FOUND,"SAA3","해당 Playlist가 존재하지 않습니다."),
    ...
    NOT_EXIST_TITLE_DIARY(HttpStatus.BAD_REQUEST,"SAD2","제목이 없습니다."),
    NOT_EXIST_COMMENT_DIARY(HttpStatus.BAD_REQUEST,"SAD3","내용이 없습니다.");
